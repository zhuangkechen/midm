...
if __name__ == "__main__":
    ...
    rawPath = "hdfs://node06:9000/user/function/mb_analysis/the_network/retweet_network"
    #input_path = "hdfs://node06:9000/user/function/mb_analysis/gaddafi_analysis/large_topic_users_count_20_and_1"
    input_path = "hdfs://node06:9000/user/function/mb_analysis/gaddafi_analysis/topic_user_split/large_topic_users_count_1"
    output_path = "hdfs://node06:9000/user/function/mb_analysis/new_network_analysis/network_tmp2"
    output_path_10 = "hdfs://node06:9000/user/function/mb_analysis/new_network_analysis/network_tmp_10"
    output_path_5 = "hdfs://node06:9000/user/function/mb_analysis/new_network_analysis/network_tmp_5"
    output_path_30000 = "hdfs://node06:9000/user/function/mb_analysis/new_network_analysis/network_tmp_30000"
    output_path_50000 = "hdfs://node06:9000/user/function/mb_analysis/new_network_analysis/network_tmp_50000"
    output_path_100000 = "hdfs://node06:9000/user/function/mb_analysis/new_network_analysis/network_tmp_100000"
    ...
    all_users =  raw_users.leftOuterJoin(choosen_users, 1)\
    ...
    for i in range(0, 20):
        ...
        print "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n"
        print "\n\n"
        loop = loop.groupByKey(1).flatMap(lambda word: re_split(word))
